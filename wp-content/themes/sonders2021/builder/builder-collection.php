...
<section class="single-builder-section builder-floorplans">
	...
	<?php if(get_sub_field('floorplan_video') != ''): ?>
		<a class="link link--arrowed floorplan-tour-btn" data-target="#<?php echo str_replace(' ', '-',strtolower(get_sub_field('floorplan_name') . '-video')) ?>">Video Tour <?php echo file_get_contents(get_template_directory() . '/assets/images/icons/arrow-icon.svg') ?></a>
	<?php else: ?>
		&nbsp;
	<?php endif; ?>
	</p>
