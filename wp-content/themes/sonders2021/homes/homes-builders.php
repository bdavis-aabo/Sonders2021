  ...
  <?php if($_builders->have_posts()): ?>
	<section class="page-section homebuilders-segments blue-bg">
		<div class="segment-container">
            ...
            Learn More <?php echo file_get_contents_curl(get_template_directory_uri() . '/assets/images/icons/arrow-icon.svg') ?>
          </a>
				</div>
      ...
      <article class="builder" id="builder-<?php echo $post->post_name ?>">
        ...
        <div class="builder-details">
          ...
          <a href="<?php the_permalink() ?>" title="<?php the_title() ?>" class="link link--arrowed">
            View the homes <?php echo file_get_contents_curl(get_template_directory_uri() . '/assets/images/icons/arrow-icon.svg') ?>
          </a>
        </div>
      </article>
    <?php endwhile; ?>
