<section class="page-section learning-section center-section">
  ...
  <?php while(have_rows('idea_studio')): the_row(); $_galleryImages = get_sub_field('idea_gallery'); $_smallImage = get_sub_field('small_image'); ?>
    ...
    <div class="learning-contents idea-contents">
      ...
      <div class="learning-right">
		<div class="learning-right-contents"><?php echo get_sub_field('idea_studio_content') ?></div>
      </div>
    </div>
  <?php endwhile; ?>
  </div>
