<section class="page-section learning-section center-section amenities-section">
  <div class="learning-center-container">
  <?php while(have_rows('amenities')): the_row(); $_galleryImages = get_sub_field('amenities_gallery'); $_smallImage = get_sub_field('small_image'); ?>
    ...
    <div class="learning-contents">
      ...
      <div class="learning-right">
		<div class="learning-right-contents"><?php echo get_sub_field('amenities_content') ?></div>
      </div>
    </div>
  <?php endwhile; ?>
  </div>
